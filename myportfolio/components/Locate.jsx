...
const Locate = () => {
    ...
    return (
        <div className='flex flex-col w-full pt-[64]  px-1 item-center justify-center overflow-x-hidden'>
            <div className='h-fit w-[300x] rounded-lg mx-auto md:w-[450px] lg:w-[600px] xl:w-[800px] overflow-x-hidden'>
            ...
            allow="accelerometer; gyroscope" className='pt-[128px] pb-[84px] w-full h-[350px] rounded-sm mx-auto' referrerPolicy="no-referrer-when-downgrade">
            </iframe>
            </div>
        </div>
    );
