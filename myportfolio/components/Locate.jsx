...
const Locate = () => {
    ...
    return (
        <div className='flex flex-col w-full pt-[64px]  px-1 item-center justify-center overflow-x-hidden'>
            ...
            <LocateIcon className='text-darkTheme dark:text-white mx-auto justify-center items-center w-24 h-24'/>
            ...
            allow="accelerometer; gyroscope" className='font-regular relative flex flex-col items-center justify-center pt-[10px] pb-[84px] w-[300px] h-[500px] rounded-lg mx-auto' referrerPolicy="no-referrer-when-downgrade">
            </iframe>
            </div>
        </div>
    );
