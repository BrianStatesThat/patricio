...
const Locate = () => {
    ...
    return (
        <div className='flex flex-col w-full h-full pt-[64] pb-[84px] px-1 item-center justify-center overflow-x-hidden'>
            ...
            <div id="map" className='h-fit w-[300x] rounded-lg mx-auto md:w-[450px] lg:w-[600px] xl:w-[800px] overflow-hidden'>
            ...
            allow="accelerometer; gyroscope" className='w-full h-[350px] rounded-sm mx-auto' referrerPolicy="no-referrer-when-downgrade">
            </iframe>
            </div>
        </div>
    );
